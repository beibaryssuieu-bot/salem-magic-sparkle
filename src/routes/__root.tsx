...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "TÄRBIE OS — мектептің тәрбие жұмысын басқару жүйесі" },
      { property: "og:description", content: "TÄRBIE OS — мектептің тәрбиелік көрсеткіштерін жинайтын, талдайтын және сынып жетекшілеріне жеке шкала беретін цифрлық басқару жүйесі." },
      { name: "twitter:description", content: "TÄRBIE OS — мектептің тәрбиелік көрсеткіштерін жинайтын, талдайтын және сынып жетекшілеріне жеке шкала беретін цифрлық басқару жүйесі." },
