...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TÄRBIE OS — тәрбие жұмысының цифрлық жүйесі" },
      {
        property: "og:description",
        content:
          "Әр сынып жетекшісі өз сыныбының тәртіп, қатысу, кітап оқу және психологиялық ахуал шкаласын онлайн бақылайды.",
      },
